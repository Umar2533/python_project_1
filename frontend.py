...
# st.markdown('<h1 class="title">📄 PDF Query App</h1>', unsafe_allow_html=True)


# # ============ Tabs ============
# tab1, tab2, tab3, tab4, tab5 = st.tabs(
#     ["📤 Upload", "📥 Retrieve", "✏️ Update", "🗑️ Delete", "🤖 Query LLM"]
# )
...
# # ------------------ Retrieve ------------------
# with tab2:
#     st.header("📥 Retrieve File Data")
#     file_id = st.text_input("Enter File ID", value=st.session_state.get("last_file_id", ""))
...
#                 st.text_area("Extracted Text", result["text"], height=250)
#             else:
...
# # ------------------ Update ------------------
# with tab3:
#     st.header("✏️ Update PDF File")
#     file_id = st.text_input("Enter File ID to Update", value=st.session_state.get("last_file_id", ""))
#     updated_file = st.file_uploader("Choose New PDF File", type=["pdf"], key="update_file")

#     if updated_file and st.button("Update"):
...
# # ------------------ Delete ------------------
# with tab4:
#     st.header("🗑️ Delete PDF File")
#     file_id = st.text_input("Enter File ID to Delete", value=st.session_state.get("last_file_id", ""))
...
# # ------------------ Query with LLM ------------------
# with tab5:
#     st.header("🤖 Query PDF with LLM")
#     file_id = st.text_input("Enter File ID to Query", value=st.session_state.get("last_file_id", ""))
#     question = st.text_area("Ask a Question")

#     if st.button("Query LLM"):
#         if not file_id or not question.strip():
